...
export const en = {
  ...
  auth: {
    ...
    password: "Password",
    usernamePlaceholder: "emil or you@company.com",
    usernameHint: "A short name, or your work email — like other apps.",
    ...
    invalidCredentials:
      "We couldn’t sign you in. Check your username or email and password.",
    tooManyAttempts: "Too many sign-in attempts. Please wait a few minutes and try again.",
    usernamePasswordRequired: "Enter your username or email and password.",
    usernameRequired: "Enter a username or email address.",
    couldNotLogIn: "We couldn’t sign you in. Please try again.",
    tooManyRegister:
      "Too many registration attempts. Please wait a few minutes and try again.",
    usernameMin: "Use at least 3 characters for a username.",
    usernameMax: "That’s a bit too long. Please shorten it.",
    usernameChars:
      "Usernames can use letters, numbers, dots, underscores, and hyphens — or enter your email.",
    usernameEmail: "Enter a valid email, like you@company.com.",
    passwordRequired: "Enter your password.",
    passwordMin: "Use at least 6 characters for your password.",
    passwordMax: "That password is too long. Use 128 characters or fewer.",
    invalidInput: "Please check the form and try again.",
    usernameReserved: "This name is reserved. Please choose another.",
    usernameTaken:
